          ...
          <div className="max-w-6xl mx-auto">
              ...
              {[
                {
                  title: "Direktur",
                  description:
                    "Memimpin seluruh kegiatan perusahaan, membuat keputusan strategis, dan memastikan visi serta misi tercapai.",
                  icon: <FaUserTie className="w-6 h-6" />,
                },
                {
                  title: "Wakil Direktur",
                  description:
                    "Mendukung direktur, menggantikan peran direktur saat berhalangan, serta mengawasi pelaksanaan kebijakan perusahaan.",
                  icon: <FaUserCog className="w-6 h-6" />,
                },
                {
                  title: "Manajer Keuangan",
                  description:
                    "Mengelola arus kas, menyusun laporan keuangan, dan merencanakan anggaran perusahaan.",
                  icon: <FaMoneyBillWave className="w-6 h-6" />,
                },
                {
                  title: "Manajer HRD",
                  description:
                    "Bertanggung jawab dalam rekrutmen, pelatihan, dan pengembangan sumber daya manusia.",
                  icon: <FaUsersCog className="w-6 h-6" />,
                },
                {
                  title: "Manajer Proyek",
                  description:
                    "Mengatur timeline proyek, koordinasi tim, dan memastikan proyek selesai sesuai target.",
                  icon: <FaProjectDiagram className="w-6 h-6" />,
                },
                {
                  title: "Quality Assurance",
                  description:
                    "Menjamin kualitas produk/jasa dengan melakukan pengujian dan evaluasi standar.",
                  icon: <FaCheckCircle className="w-6 h-6" />,
                },
                {
                  title: "Manajer Kurikulum",
                  description:
                    "Mengembangkan kurikulum pelatihan internal agar sesuai dengan kebutuhan perusahaan.",
                  icon: <FaBookOpen className="w-6 h-6" />,
                },
                {
                  title: "Manajer Pemasaran",
                  description:
                    "Menyusun strategi pemasaran, promosi, dan analisis pasar untuk meningkatkan penjualan.",
                  icon: <FaBullhorn className="w-6 h-6" />,
                },
                {
                  title: "Bendahara",
                  description:
                    "Mengelola kas perusahaan dan memastikan laporan keuangan harian tercatat dengan baik.",
                  icon: <FaWallet className="w-6 h-6" />,
                },
                {
                  title: "Manajer Cabang Banyuwangi",
                  description:
                    "Mengawasi operasional cabang Banyuwangi serta memastikan target bisnis tercapai.",
                  icon: <FaMapMarkerAlt className="w-6 h-6" />,
                },
                {
                  title: "Senior Developer Banyuwangi",
                  description:
                    "Memimpin tim developer cabang, memberikan solusi teknis, dan mengawasi coding standard.",
                  icon: <FaCode className="w-6 h-6" />,
                },
                {
                  title: "Social Media Specialist",
                  description:
                    "Mengelola akun media sosial, membuat konten kreatif, dan meningkatkan engagement.",
                  icon: <FaInstagram className="w-6 h-6" />,
                },
                {
                  title: "UI/UX Designer",
                  description:
                    "Mendesain tampilan dan pengalaman pengguna yang intuitif dan menarik.",
                  icon: <FaPaintBrush className="w-6 h-6" />,
                },
                {
                  title: "Frontend Developer",
                  description:
                    "Mengembangkan antarmuka aplikasi agar responsif, interaktif, dan user-friendly.",
                  icon: <FaLaptopCode className="w-6 h-6" />,
                },
                {
                  title: "Mobile Developer",
                  description:
                    "Membuat dan mengembangkan aplikasi mobile (Android/iOS) sesuai kebutuhan bisnis.",
                  icon: <FaMobileAlt className="w-6 h-6" />,
                },
                {
                  title: "Backend Developer",
                  description:
                    "Mengelola server, database, dan API agar aplikasi dapat berjalan dengan lancar.",
            ...
            <div className="mt-16 text-center" data-aos="fade-up">
              <div className="inline-flex items-center space-x-6">
                <a
                  href="/images/about/StructureOrganisations.png"
                  download
                  className="text-[#1273EB] font-semibold hover:text-[#0d5bb8] transition-colors duration-300 flex items-center"
                >
                  <svg
